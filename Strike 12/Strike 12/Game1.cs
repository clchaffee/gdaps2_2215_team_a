        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            switch (state)
            {
                ...
                case GameState.Arena:
                    ...
                    clockAnimation.Draw(_spriteBatch, clockMinute, new Rectangle(0, 0, 70, 70), SpriteEffects.None, 0f, windowWidth, 1f);
                    // Draw the tiles
                        ...
                        else if (enemy is Enemy)
                        {
                            ...
                            switch (enemyState)
                            {
                                case (EnemyStates.moveRight):
                                    enemy.UpdateAnimation(_spriteBatch, enemyBase, enemy.Size, SpriteEffects.FlipHorizontally, 0, 64, 1f);
                                    break;
                                case (EnemyStates.moveLeft):
                                    enemy.UpdateAnimation.Draw(_spriteBatch, enemyBase, enemy.Size, SpriteEffects.None, 0, 64, 1f);
                                    break;
                            }
                        }
